...
export default function AffiliatePage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Creator Affiliate Program</h1>
        <p className="mt-1 text-sm text-gray-500">
          Refer other creators to OpenFans and earn {commissionRate}% of their revenue
        </p>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5">
        ...
        <div className="mt-3 flex gap-2">
          <button
            onClick={() =>
              window.open(
                `https://wa.me/?text=${encodeURIComponent(`Start creating on OpenFans — keep 95% of your earnings! ${affiliate?.referral_link ?? ""}`)}`,
                "_blank",
              )
            }
      ...
      <div className="rounded-xl border border-[#00AFF0]/20 bg-[#00AFF0]/5 p-5">
        <h3 className="text-sm font-bold text-gray-900">How the creator affiliate program works</h3>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Send your referral link to other creators you think would thrive on OpenFans
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">They join as a creator</p>
              <p className="text-xs text-gray-500">
                When another creator signs up through your link and starts earning, they become your referral
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">You earn {commissionRate}%</p>
              <p className="text-xs text-gray-500">
                Earn {commissionRate}% of the revenue generated by creators you referred
              </p>
            </div>
          </div>
        </div>
