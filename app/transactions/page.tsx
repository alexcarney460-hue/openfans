            ...
            <table className="w-full" role="table">
              <thead>
                <tr className="border-b border-white/[0.06]">
                  ...
                  <th className="px-5 py-3 text-right text-xs font-medium uppercase tracking-wider text-white/30">
                    Amount (USDC)
                  </th>
                  <th className="px-5 py-3 text-right text-xs font-medium uppercase tracking-wider text-white/30">
                    Status
              ...
              <tbody className="divide-y divide-white/[0.04]">
                {filtered.map((tx) => (
                  ...
                  >
                    <td className="whitespace-nowrap px-5 py-4 text-sm text-white/60">
                      {tx.date}
                    </td>
