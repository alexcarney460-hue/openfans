      ...
      <main className="flex-1 pt-14">
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-sm leading-relaxed text-white/60">
            <section>
              <h2 className="text-lg font-semibold text-white mb-3">1. Terms of Use</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-white mb-3">3. Content Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-white mb-3">4. Payments</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-white mb-3">5. DMCA &amp; Copyright</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-white mb-3">6. Privacy</h2>
              <p>
