    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-gray-200 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <button
            type="button"
            className="relative z-[60] inline-flex items-center justify-center rounded-md p-2 text-gray-500 hover:text-gray-900 active:bg-gray-100 md:hidden"
      ...
      {/* Mobile Menu — rendered as fixed overlay outside header to avoid stacking context issues */}
      {mobileOpen && (
        <>
          {/* Backdrop */}
          <div
          ...
          />
          {/* Menu panel */}
          <div className="fixed top-14 left-0 right-0 z-[60] border-b border-gray-200 bg-white shadow-lg md:hidden">
